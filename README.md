...
- DP_SGD_out_of_Band_NC_attack.ipynb (DP-SGD + Dynamic encoding optimization with GAN (covertex-DG for out-of-the band NC samples with Lenet-5 + MNIST)
- DP_SGD_Inband_NC_attack (DP-SGD + covertex-C for in-band NC samples Lenet-5 + MNIST)
